...
public class PromoterService {
    ...
    public PromoterService(PromoterRepository promoterRepo, SmeRepository smeRepo,
    ...
    public PromoterResponse addPromoter(Long smeId, AddPromoterRequest req) {
        ...
        if (!owner && !privileged) {
            throw new ApiException(HttpStatus.FORBIDDEN, "You are not allowed to add a promoter for this SME");
        }
    ...
    public List<PromoterResponse> listBySme(Long smeId) {
        ...
        String role = me.getRole().getRoleName().name();
        boolean privileged = role.equals("AGENT") || role.equals("ADMIN") || role.equals("UNDERWRITER");
        boolean owner = sme.getCreatedBy() != null && sme.getCreatedBy().getUserId().equals(me.getUserId());
    ...
    public PromoterResponse get(Long promoterId) {
        ...
        boolean privileged = role.equals("AGENT") || role.equals("ADMIN") || role.equals("UNDERWRITER");
        Sme sme = p.getSme();
        boolean owner = sme != null && sme.getCreatedBy() != null
                && sme.getCreatedBy().getUserId().equals(me.getUserId());
